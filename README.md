...
4. videodownloader function: Performing a chmod on the downloaded file to 755 to resolve access issues if you're using a different user for the cron job
